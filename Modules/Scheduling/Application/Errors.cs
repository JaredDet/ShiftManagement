...
public static class SchedulingErrors
{
    public static readonly Error ShiftNotFound =
        new("scheduling.shift.not_found", "Shift not found");

    public static readonly Error ShiftAlreadyExists =
        new("scheduling.shift.already_exists", "Shift already exists");

    public static readonly Error ShiftInvalidTimeRange =
        new("scheduling.shift.invalid_time_range", "Shift end time must be after start time");

    public static readonly Error ShiftAlreadyAssigned =
        new("scheduling.shift.already_assigned", "Shift already has an active assignment");

    public static readonly Error CollaboratorNotAvailable =
        new("scheduling.collaborator.not_available", "Collaborator is not available for this shift");

    public static readonly Error InvalidShiftState =
        new("scheduling.shift.invalid_state", "Shift is in an invalid state for this operation");
